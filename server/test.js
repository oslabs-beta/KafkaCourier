...
const run = async () => {
  ...
  ///need to receive groupName from frontend
  //exec command
  const command = `kafka-consumer-groups --bootstrap-server ${server} --command-config server/cloud.properties --group ${groupName} --describe`;
  exec(command, (error, stdout, stderr) => {
    ...
    console.log('Lag ARRAY', newArray2);
